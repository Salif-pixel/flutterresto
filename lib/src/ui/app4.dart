...
class MyPage4 extends StatelessWidget {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                buildinputuser(),
                buildinputpassword(passwordcontroller, "mot de passe actuel"),
                buildinputpassword(passwordcontroller1, "nouveau mot de passe"),
                buildinputpassword(
                    passwordcontroller2, "confirmer nouveau mot de passe"),
                GestureDetector(
                  child: buildvalid(context),
                  onTap: () {
                    BlocProvider.of<UserAuthbloc>(context).add(UserRefreshEvent(
                      mail: usercontroller.text.toString(),
                      password: passwordcontroller.text.toString(),
                      Npassword: passwordcontroller1.text.toString(),
                      Npassword1: passwordcontroller2.text.toString(),
                    ));
                  },
                ),
  ...
  Widget buildinputpassword(
          TextEditingController PasswordControll, String hint) =>
      Container(
        margin: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
        padding: EdgeInsets.symmetric(horizontal: 16),
        decoration: BoxDecoration(
